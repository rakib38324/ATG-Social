...
const createComment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield comment_service_1.CommentServices.createCommentIntoDB(req.body, req.user);
...
const getAllCommentWithPostId = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { postId } = req.params;
    const result = yield comment_service_1.CommentServices.getCommentWithPostIdInFromDB(postId);
    (0, commonResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
